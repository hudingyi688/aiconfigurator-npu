...
from aiconfigurator_npu.sdk.models import _apply_model_quant_defaults, check_is_moe, get_model_family
from aiconfigurator_npu.sdk.pareto_analysis import get_pareto_front
from aiconfigurator_npu.sdk.perf_database import get_database, get_latest_database_version
from aiconfigurator_npu.sdk.utils import ListFlowDumper, enumerate_parallel_config, get_model_config_from_model_path
...
class TaskRunner:
    ...
    def run_agg(self, task_config: DefaultMunch) -> dict[str, pd.DataFrame | None]:
        ...
        try:
            from aiconfigurator_npu.sdk import pareto_analysis as pa
