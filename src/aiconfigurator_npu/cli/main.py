...
from aiconfigurator_npu.logging_utils import setup_logging
from aiconfigurator_npu.sdk import common, perf_database
from aiconfigurator_npu.sdk.task import TaskConfig, TaskRunner
from aiconfigurator_npu.sdk.utils import ListFlowDumper, get_model_config_from_model_path
...
def _run_estimate_mode(args):
    ...
    from aiconfigurator_npu.cli.api import cli_estimate
