...
from aiconfigurator_npu.cli.main import (
...
from aiconfigurator_npu.cli.report_and_save import save_results
from aiconfigurator_npu.sdk.models import check_is_moe
from aiconfigurator_npu.sdk.task import (
...
def cli_support(
    ...
    *,
    ...
    """
    from aiconfigurator_npu.sdk.common import check_support
    from aiconfigurator_npu.sdk.utils import get_model_config_from_model_path
...
def _build_model_config(
    ...
    from aiconfigurator_npu.sdk.config import ModelConfig
    ...
    *,
    ...
    def _load_database(sys_name: str):
        ...
        if database_mode != "SILICON":
            from aiconfigurator_npu.sdk.common import DatabaseMode
...
from aiconfigurator_npu.generator.api import generate_naive_config as cli_generate
